            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li>
                            <a href="?p=incoming.read">Surat Keluar</a>
                        </li>
                        <li class="active">
                        ...
                        <button aria-hidden="true" data-dismiss="alert" class="close" type="button">×</button>
                            ...
                            <form action="?p=outgoing.action" method="post" class="form-horizontal" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10"><textarea class="summernote" name="isisurat">
                                    <?php echo $row['isisurat']; ?> </textarea>
                                    </div>
                                </div>
                                <div class="hr-line-dashed"></div>
                                <div class="form-group">
                                    <label class="col-sm-2 control-label">Tindakan Pemeriksaan</label>
                                    <div class="col-sm-6">
                                    <select class="select2_demo_3 form-control" name="uac" required="">
                                        <option></option>
                                        <option value="ADM">Setujui, lanjutkan ke Staf TU</option>
                                        <option value="<?php echo $row['uac']; ?>">Tolak ke <?php echo $row['bgn']; ?></option>
                                    </select>
                                    </div>
                                </div>
                                <div class="hr-line-dashed"></div>
