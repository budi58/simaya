                ...
                <div class="ibox float-e-margins">
                    ...
                    <?php
                        ...
                        foreach ($res as $row) {
                            ...
                            if ($tembusan == "KPH"){
                                $tembusan = 'Dihadiri sendiri / Kabag. Perleng. & Humas';
                            }elseif($tembusan == "KPER"){
                                $tembusan = 'Diwakilkan / Kasubag Perlengkapan';
                            }elseif($tembusan == 'KSHum'){
                                $tembusan = 'Diwakilkan / Kasubag Humas&Protokol';
                            }elseif($tembusan == 'KSRT'){
                                $tembusan = 'Diwakilkan / Kasubag Rumahtangga';
                            }else{
                                echo '';
                            }
                    ...
                    <tr>
                        ...
                        <input type="hidden" name="q" value="<?php echo $getId ?>" >
                            <select class="select2_demo_3 form-control" name="tembusan" value="<?php echo $row['tembusan']; ?>" required="">
                                ...
                                <option value="KPH">Dihadiri sendiri / Kabag. Perleng. & Humas</option>
                                <option value="KPER">Diwakilkan / Kasubag Perlengkapan</option>
                                <option value="KSHum">Diwakilkan / Kasubag Humas&Protokol</option>
                                <option value="KSRT">Diwakilkan / Kasubag Rumahtangga</option>
                            </select>
                        </td>
                        <td>
