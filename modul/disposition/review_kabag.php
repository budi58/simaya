            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">
                            <strong>Informasi Disposisi Surat</strong>
                        </li>
                    </ol>
                </div>
                <div class="col-lg-2">
            ...
            <div class="col-lg-12">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>Informasi Disposisi Surat</h5>
                    ...
                    <?php
                        ...
                        if ($tembusan == "KBG"){
                            $tembusan = 'Dihadiri sendiri / Kabag. Umum';
                        }elseif($tembusan == "KSBG"){
                            $tembusan = 'Diwakilkan / Kasubag TU dan Kepeg.';
                        }elseif($tembusan == 'SBGK'){
                            $tembusan = 'Diwakilkan / Kasubag Keuangan';
                        }elseif($tembusan == 'KPEP'){
                            $tembusan = 'Diwakilkan / Kasubag PEP';
                        }else{
                            echo '';
                        }
                    ...
                    <tr>
                        ...
                        <input type="hidden" name="q" value="<?php echo $getId ?>" >
                            <select class="select2_demo_3 form-control" name="tembusan" value="<?php echo $row['tembusan']; ?>" required="">
                                ...
                                <option value="KBG">Dihadiri Sendiri / Kabag. Umum</option>
                                <option value="KSBG">Diwakilkan / Kasubag TU dan Kepeg.</option>
                                <option value="SBGK">Diwakilkan / Kasubag Keuangan</option>
                                <option value="KPEP">Diwakilkan / Kasubag PEP</option>
                            </select>
                        </td>
                        <td>
