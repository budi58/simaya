            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">
                            <strong>Surat Masuk Review</strong>
                        </li>
                    </ol>
                </div>
                <div class="col-lg-2">
                            ...
                            <form action="?p=incoming.action" method="post" class="form-horizontal" enctype="multipart/form-data">
                                ...
                                <div class="form-group" id="datepicker">
                                    ...
                                    <div class="input-group date">
                                        <span class="input-group-addon"><i class="fa fa-calendar"></i></span><input type="text" name="tglaccept" class="form-control" value="<?php echo date_format(date_create($row['tglaccept']), 'd/m/Y'); ?>" autocomplete="off" />
                                    </div>
                                    </div>
                                </div>
                                <div class="hr-line-dashed"></div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6"><input type="text" name="nosurat" class="form-control" value="<?php echo $row['nosurat']; ?>" >
                                    </div>
                                </div>
                                <div class="hr-line-dashed"></div>
                                <div class="form-group" id="datepicker">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6"><a href="files/incoming/<?php echo $row['file']; ?>" target="_blank"><?php echo $row['file']; ?></a> <input type="file" name="file">
                                ...
                                <div class="form-group">
                                    ...
                                    <option value="<?php echo $row['id_ag']?>"> <?php echo $row['agenda'] ?></option>  
                                    <?php
                                ...
                                <div class="form-group">
                                    <div class="col-sm-6 col-sm-offset-3">
                                        <a class="btn btn-white" href="?p=incoming.read">Cancel</a>
