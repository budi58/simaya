                        ...
                        <button aria-hidden="true" data-dismiss="alert" class="close" type="button">×</button>
                            ...
                            <form action="?p=incoming.action" method="post" class="form-horizontal" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                    <input type="text" name="lamp" class="form-control" value="<?php echo $row['lamp']; ?>" readonly>
                                    </div>
                                </div>
                                <div class="hr-line-dashed"></div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                    <select class="select2_demo_3 form-control" name="agenda"> 
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="select2_demo_3 form-control" name="uac" required="">
                                        <option></option>
                                        <option value="DWN">Setujui, lanjutkan ke Ketua Dewan</option>
                                ...
                                <div class="form-group">
                                    <div class="col-sm-6 col-sm-offset-3">
                                        ...
                                        <a href="?p=incoming.dispo&q=<?php echo $row['id_sm']; ?>" class="btn btn-success">Buat Disposisi</a>
                                    </div>
                                </div>
                            </form>
                            </div>
