                ...
                <div class="row">
                    <div class="col-lg-8">
                        ...
                        <div class="mail-box">
                            ...
                            <tbody>
                            <?php 
                                $sql = "SELECT id_sm, tglaccept, perihal, agenda, pengirim, uac, status FROM tb_suratmasuk
                                INNER JOIN tb_agenda ON (tb_suratmasuk.id_ag = tb_agenda.id_ag)
                                WHERE uac = 'KBG' OR uac = 'SWN' OR uac = 'DWN' 
                        ...
                        <div class="mail-box">
                            ...
                            <?php 
                                $sql = "SELECT id_sk, nosk, tglsurat, pengirim, perihal, id_us, uac, status 
                                            FROM tb_suratkeluar WHERE id_us = '3' 
